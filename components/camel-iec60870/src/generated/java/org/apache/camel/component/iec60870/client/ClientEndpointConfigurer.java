...
public class ClientEndpointConfigurer extends PropertyConfigurerSupport implements GeneratedPropertyConfigurer, PropertyConfigurerGetter {
    ...
    public boolean configure(CamelContext camelContext, Object obj, String name, Object value, boolean ignoreCase) {
        ...
        case "adsuAddressType": target.getConnectionOptions().setAdsuAddressType(property(camelContext, org.eclipse.oneofour.ASDUAddressType.class, value)); return true;
        case "basicpropertybinding":
        case "basicPropertyBinding": target.setBasicPropertyBinding(property(camelContext, boolean.class, value)); return true;
        case "bridgeerrorhandler":
        case "bridgeErrorHandler": target.setBridgeErrorHandler(property(camelContext, boolean.class, value)); return true;
        case "causeoftransmissiontype":
        case "causeOfTransmissionType": target.getConnectionOptions().setCauseOfTransmissionType(property(camelContext, org.eclipse.oneofour.CauseOfTransmissionType.class, value)); return true;
        ...
        case "dataModuleOptions": target.getConnectionOptions().setDataModuleOptions(property(camelContext, org.eclipse.oneofour.client.data.DataModuleOptions.class, value)); return true;
        ...
        case "informationObjectAddressType": target.getConnectionOptions().setInformationObjectAddressType(property(camelContext, org.eclipse.oneofour.InformationObjectAddressType.class, value)); return true;
        ...
        case "protocolOptions": target.getConnectionOptions().setProtocolOptions(property(camelContext, org.eclipse.oneofour.ProtocolOptions.class, value)); return true;
        case "statelistener":
        case "stateListener": target.getConnectionOptions().setStateListener(property(camelContext, org.eclipse.oneofour.client.AutoConnectClient.StateListener.class, value)); return true;
    ...
    public Map<String, Object> getAllOptions(Object target) {
        ...
        answer.put("adsuAddressType", org.eclipse.oneofour.ASDUAddressType.class);
        answer.put("basicPropertyBinding", boolean.class);
        answer.put("bridgeErrorHandler", boolean.class);
        answer.put("causeOfTransmissionType", org.eclipse.oneofour.CauseOfTransmissionType.class);
        ...
        answer.put("dataModuleOptions", org.eclipse.oneofour.client.data.DataModuleOptions.class);
        ...
        answer.put("informationObjectAddressType", org.eclipse.oneofour.InformationObjectAddressType.class);
        answer.put("lazyStartProducer", boolean.class);
        answer.put("maxUnacknowledged", short.class);
        answer.put("protocolOptions", org.eclipse.oneofour.ProtocolOptions.class);
        answer.put("stateListener", org.eclipse.oneofour.client.AutoConnectClient.StateListener.class);
