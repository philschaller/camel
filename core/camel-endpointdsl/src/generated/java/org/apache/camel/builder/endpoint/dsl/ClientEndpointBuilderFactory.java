...
public interface ClientEndpointBuilderFactory {
    ...
    public interface ClientEndpointConsumerBuilder
         ...
         * 
         * The option is a:
         * <code>org.eclipse.oneofour.client.data.DataModuleOptions</code> type.
         * 
         * Group: common
         */
         ...
         * Protocol options.
         * 
         * The option is a: <code>org.eclipse.oneofour.ProtocolOptions</code>
         * type.
         * 
         * Group: common
         */
         ...
         * 
         * The option will be converted to a
         * <code>org.eclipse.oneofour.ProtocolOptions</code> type.
         * 
         * Group: common
         */
        default ClientEndpointConsumerBuilder protocolOptions(
         ...
         * Group: common
         */
        default ClientEndpointConsumerBuilder stateListener(Object stateListener) {
         ...
         * Group: common
         */
        default ClientEndpointConsumerBuilder stateListener(String stateListener) {
            doSetProperty("stateListener", stateListener);
            return this;
        }
        /**
         ...
         * 
         * The option is a: <code>org.eclipse.oneofour.ASDUAddressType</code>
         * type.
         * 
         * Group: connection
         */
         ...
         * 
         * The option will be converted to a
         * <code>org.eclipse.oneofour.ASDUAddressType</code> type.
         * 
         * Group: connection
         */
        default ClientEndpointConsumerBuilder adsuAddressType(
         ...
         * 
         * The option is a:
         * <code>org.eclipse.oneofour.CauseOfTransmissionType</code> type.
         * 
         * Group: connection
         */
         ...
         * 
         * The option is a:
         * <code>org.eclipse.oneofour.InformationObjectAddressType</code> type.
         * 
         * Group: connection
         */
    ...
    public interface ClientEndpointProducerBuilder
         ...
         * Group: common
         */
        default ClientEndpointProducerBuilder stateListener(Object stateListener) {
            doSetProperty("stateListener", stateListener);
            return this;
        }
        /**
         ...
         * Group: common
         */
        default ClientEndpointProducerBuilder stateListener(String stateListener) {
            doSetProperty("stateListener", stateListener);
            return this;
        }
        /**
    ...
    public interface ClientEndpointBuilder
         ...
         * Group: common
         */
        default ClientEndpointBuilder stateListener(Object stateListener) {
            doSetProperty("stateListener", stateListener);
            return this;
        }
        /**
         ...
         * Group: common
         */
        default ClientEndpointBuilder stateListener(String stateListener) {
            doSetProperty("stateListener", stateListener);
            return this;
        }
        /**
    ...
    /**
     * Proxy enum for <code>org.eclipse.oneofour.ASDUAddressType</code> enum.
     */
    ...
    /**
     * Proxy enum for <code>org.eclipse.oneofour.CauseOfTransmissionType</code>
     * enum.
     */
    ...
    /**
     * Proxy enum for
     * <code>org.eclipse.oneofour.InformationObjectAddressType</code> enum.
     */
    ...
    public interface ClientBuilders {
         ...
         * using Eclipse OneOFour implementation.
         * 
         * Category: iot
         * Since: 2.20
